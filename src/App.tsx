  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 left-4">
        <span className="text-[9px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full" style={{ background: "rgba(201,162,39,0.85)", color: "#040d1a" }}>
          {exp.tag}
        </span>
      </div>
    ...
    >
      {rate.popular && (
        <div className="flex justify-center pt-0">
          <span className="text-[9px] font-bold uppercase tracking-widest px-5 py-1.5 rounded-b-xl" style={{ background: "#c9a227", color: "#040d1a" }}>
            Most Popular
          </span>
        </div>
      )}
  ...
  return (
    ...
    >
      ...
      <img
        ...
        style={{ aspectRatio: item.tall ? "3/4" : "16/9", transition: "transform 0.7s cubic-bezier(0.19,1,0.22,1)", transform: hovered ? "scale(1.08)" : "scale(1)", pointerEvents: "none" }}
      />
        ...
        <div className="flex flex-col lg:flex-row overflow-y-auto flex-1 min-h-0">
          ...
          <div className="relative flex-shrink-0 lg:w-[52%]" style={{ background: "#020201" }}>
            ...
            <div
              ...
              style={{ height: 60, background: "linear-gradient(to bottom, rgba(6,14,30,0.9), transparent)" }}
            />
            {/* Bottom overlay with controls */}
            <div
              className="absolute bottom-0 left-0 right-0"
              style={{ background: "linear-gradient(to top, rgba(6,14,30,0.98) 0%, rgba(6,14,30,0.4) 60%, transparent 100%)", padding: "20px 20px 16px" }}
            >
              {/* Progress bar */}
              <div className="w-full h-[2px] rounded-full mb-3" style={{ background: "rgba(255,255,255,0.1)" }}>
                <div
                  className="h-full rounded-full transition-all"
                  style={{ width: `${videoProgress}%`, background: "linear-gradient(90deg, #c9a227, #f0c040)", boxShadow: "0 0 8px rgba(201,162,39,0.6)" }}
                />
              </div>
              {/* Controls row */}
            ...
            <div
              ...
              style={{ background: "rgba(6,14,30,0.8)", backdropFilter: "blur(12px)", border: "1px solid rgba(201,162,39,0.2)" }}
            >
            ...
            <div className="flex gap-2 p-4 md:p-6 pb-3 border-b border-white/5">
              {(["specs", "flybridge"] as const).map((tab) => (
                <button
                  ...
                  style={{
                    background: activeSpecTab === tab ? "rgba(201,162,39,0.15)" : "rgba(255,255,255,0.04)",
                    border: activeSpecTab === tab ? "1px solid rgba(201,162,39,0.35)" : "1px solid rgba(255,255,255,0.08)",
                    color: activeSpecTab === tab ? "#c9a227" : "rgba(255,255,255,0.35)",
                  }}
                >
              ...
              {activeSpecTab === "specs" ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-4 rounded-2xl" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)" }}>
                    <p className="text-[10px] font-bold uppercase tracking-[2px] text-white/30 mb-3">Vessel Highlights</p>
                    <div className="space-y-2.5">
                      {[
                        { icon: Anchor, text: "Bahamas-friendly draft — access secluded anchorages" },
                        { icon: Zap, text: "Twin high-performance diesel engines — incredibly low hours" },
                        { icon: Wind, text: "Full vessel air conditioning in all staterooms & salons" },
                        { icon: Activity, text: "Dual generators — full power at anchor, anywhere" },
                      ].map((item, i) => (
...
function ScrollVideoSection({ openSpecsModal }: { openSpecsModal: () => void }) {
  ...
  const scrollSpecs = [
    { threshold: 0.1, label: "Lazzara Yachts", sub: "Builder", pos: "top-1/4 left-8" },
    { threshold: 0.25, label: "94 ft / 28.65 m", sub: "Length Overall", pos: "top-1/3 right-8" },
    { threshold: 0.45, label: "18–22 knots", sub: "Cruising Speed", pos: "top-1/2 left-8" },
    { threshold: 0.6, label: "4 Private Suites", sub: "Staterooms", pos: "top-1/2 right-8" },
    { threshold: 0.75, label: "Up to 12 Guests", sub: "Day Charter", pos: "bottom-1/3 left-8" },
    { threshold: 0.88, label: "Year 2000 · Refit 2022", sub: "Built · Refitted", pos: "bottom-1/3 right-8" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute top-0 left-0 right-0 h-40" style={{ background: "linear-gradient(to bottom, #020201 0%, transparent 100%)" }} />
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-40" style={{ background: "linear-gradient(to top, #020201 0%, transparent 100%)" }} />
      ...
      {scrollSpecs.map((spec, i) => (
        <AnimatePresence key={i}>
          {progress >= spec.threshold && progress < spec.threshold + 0.25 && isActive && (
            <motion.div
            ...
            >
              <div
                ...
                style={{ background: "rgba(4,13,26,0.75)", backdropFilter: "blur(14px)", border: "1px solid rgba(201,162,39,0.18)" }}
              >
                <p className="text-[9px] uppercase tracking-[2px] text-gold/50 mb-0.5">{spec.sub}</p>
                <p className="font-serif text-base text-white">{spec.label}</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
          ...
          <Modal onClose={() => setSelectedRoom(null)}>
            <div className="max-w-2xl w-full bg-navy-light rounded-3xl overflow-hidden border border-white/10 shadow-2xl overflow-y-auto max-h-[90vh] scrollbar-hide">
              ...
              <div className="p-5 md:p-10">
                ...
                <a href="#contact" onClick={() => setSelectedRoom(null)} className="w-full py-4 bg-gold text-navy font-bold rounded-xl hover:bg-gold-hover transition-colors flex items-center justify-center gap-2 text-sm">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-3 md:gap-8">
          ...
          <button onClick={openAvail} className="hidden xl:flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 hover:border-gold/30 hover:bg-white/10 transition-all cursor-pointer group/avail">
            <div className="w-2 h-2 rounded-full bg-green-500 relative"><div className="absolute inset-0 bg-green-500 rounded-full animate-pulse opacity-70" /></div>
    ...
    >
      ...
      <div className="px-6 py-5 border-t border-white/5 flex flex-col gap-3">
        ...
        <motion.a
          ...
          href="/book"
          onClick={() => setMobileMenuOpen(false)}
          className="flex items-center justify-center gap-2 w-full py-4 rounded-2xl bg-gold text-navy font-bold text-sm"
        >
        ...
        <div className="px-5 pb-4">
          <motion.div key={heroIdx + "mobile"} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            ...
            <h1 className="text-[32px] font-serif leading-[1.08] tracking-tight mb-3">
              {slides[heroIdx].line1}<br /><em className="text-gold italic font-serif">{slides[heroIdx].line2}</em>
            </h1>
...
function VesselSection({
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(135deg, #0b1929 0%, #0d1f35 50%, #091525 100%)" }}
    >
      <div className="absolute top-0 right-1/4 w-96 h-96 rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(201,162,39,0.04) 0%, transparent 70%)" }} />
      <div className="absolute bottom-0 left-1/4 w-64 h-64 rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(59,130,246,0.03) 0%, transparent 70%)" }} />
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-start">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="h-px flex-1" style={{ background: "linear-gradient(to right, rgba(201,162,39,0.3), transparent)" }} />
            <Anchor className="w-4 h-4 text-gold/40" />
            <div className="h-px flex-1" style={{ background: "linear-gradient(to left, rgba(201,162,39,0.3), transparent)" }} />
          </div>
        ...
        >
          <div className="hidden lg:block">
            <VesselInlineGallery onLightbox={openLightbox} onOpenGallery={openGallery} />
          </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 md:gap-10 mb-8 md:mb-16 relative z-30">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-serif leading-tight">
              A Floating Resort for<br /><em className="text-gold italic font-serif">Every Occasion</em>
            </h2>
          </div>
          ...
          {extendedItems.map((e, i) => (
            <motion.div
              ...
              style={{
                ...
                filter: hoveredIndex !== null && hoveredIndex !== i ? "brightness(0.7)" : "brightness(1)",
      ...
      <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-32 items-center mb-8 md:mb-16">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-serif leading-tight">
              Plan Your Yacht<br /><em className="text-gold italic font-serif">Experience Today</em>
            </h2>
          </div>
      ...
      <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-20 items-center">
        <div>
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif leading-tight mb-6">
            Questions or<br /><em className="text-gold italic font-serif">Special Requests?</em>
          </h2>
